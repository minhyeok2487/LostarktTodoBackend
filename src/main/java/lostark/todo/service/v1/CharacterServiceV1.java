...
public class CharacterServiceV1 {
     ...
     * 캐릭터 수정
     */
    public Character updateCharacter(String characterName, CharacterDayContentResponseDtoV1 characterDayContentResponseDtoV1) {
        Character character = findCharacter(characterName);
        character.getCharacterDayContent().update(characterDayContentResponseDtoV1);
        return character;
    }
