...
import lostark.todo.service.v1.lostarkApi.LostarkApiService;
...
@Slf4j
@Transactional
public class LostarkCharacterServiceV2 {

    private final LostarkApiService apiService;


    public List<Character> getCharacterList(MemberSignupDtoV2 signupDtoV2) {
        try {
