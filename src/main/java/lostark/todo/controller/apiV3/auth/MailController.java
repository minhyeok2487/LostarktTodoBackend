...
public class MailController {
    ...
    public ResponseEntity<?> sendMail(@RequestBody @Valid MailRequestDto mailRequestDto) {
        ...
        AuthResponseDto authResponseDto = new AuthResponseDto(true, "인증번호 전송이 정상처리 되었습니다.");
    ...
    public ResponseEntity<?> authMail(@RequestBody MailCheckDto mailCheckDto) {
        ...
        if (auth) {
            ...
            return new ResponseEntity<>(new AuthResponseDto(false, "인증번호가 일치하지 않거나 만료되었습니다."), HttpStatus.OK);
        }
    }
}
