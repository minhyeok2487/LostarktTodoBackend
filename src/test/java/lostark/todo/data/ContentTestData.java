...
public class ContentTestData {
    ...
    public static List<DayContent> createMockDayContents() {
        return Arrays.asList(
                // 카오스던전 - 12/10 업데이트: 보석 드랍 제거
                createDayContent(1L, Category.카오스던전, "타락1", 1415, 72415, 2438, 4.9, 76.4, 226.4, 0),
                createDayContent(2L, Category.카오스던전, "타락2", 1445, 73779, 2919, 5.6, 82.2, 241.0, 0),
                createDayContent(3L, Category.카오스던전, "타락3", 1475, 75378, 2897, 6.6, 89.1, 268.4, 0),
                createDayContent(4L, Category.카오스던전, "공허1", 1490, 76884, 5416, 3.1, 52.5, 149.9, 0),
                createDayContent(5L, Category.카오스던전, "공허2", 1520, 77565, 6885, 4.1, 63.4, 243.4, 0),
                createDayContent(6L, Category.카오스던전, "절망1", 1540, 81193, 8173, 4.8, 70.2, 207.7, 0),
                createDayContent(7L, Category.카오스던전, "절망2", 1560, 81859, 10006, 5.8, 78.2, 241.8, 0),
                createDayContent(8L, Category.카오스던전, "천공1", 1580, 80164, 9913, 3.1, 40.7, 110.0, 0),
                createDayContent(9L, Category.카오스던전, "천공2", 1600, 84164, 10128, 4.0, 44.1, 128.9, 0),
                createDayContent(10L, Category.카오스던전, "계몽1", 1610, 97382, 11198, 5.3, 60.0, 171.9, 0),
                createDayContent(91L, Category.카오스던전, "계몽2", 1630, 96918, 14349, 9.2, 95.3, 273.1, 0),
                createDayContent(110L, Category.카오스던전, "쿠르잔전선 1", 1640, 186048, 22008, 11.0, 129.5, 471.0, 0),
